...
// It allows the backend to notify a callback when a process exits unexpectedly.
type ExitAwareBackend interface {
	ProxyBackend
	// SetExitHandler registers a callback to be invoked when a process exits unintentionally.
